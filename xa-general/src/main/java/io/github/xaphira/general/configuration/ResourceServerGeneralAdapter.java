package io.github.xaphira.general.configuration;
...
public class ResourceServerGeneralAdapter extends ResourceServerConfigurerAdapter {
    ...
    public ResourceServerGeneralAdapter() {}
    public ResourceServerGeneralAdapter(TokenStore tokenStore, AccessDeniedHandler accessDeniedHandler, AuthenticationEntryPoint authenticationEntryPoint) {
