package io.github.xaphira.panic.configuration;
...
public class ResourceServerPanicAdapter extends ResourceServerConfigurerAdapter {

    private TokenStore tokenStore;
    private AccessDeniedHandler accessDeniedHandler;
    private AuthenticationEntryPoint authenticationEntryPoint;
    
    private String resourceId = ResourceCode.PANIC.getResourceId();
    
    public ResourceServerPanicAdapter() {}
    public ResourceServerPanicAdapter(TokenStore tokenStore, AccessDeniedHandler accessDeniedHandler, AuthenticationEntryPoint authenticationEntryPoint) {
