package io.github.xaphira.notification.configuration;
...
public class ResourceServerNotificationAdapter extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests()
        .antMatchers(HttpMethod.GET,"/api/" 	+resourceId+ "/ws/**")
    		.access("#oauth2.hasScope('trust')")
        .antMatchers(HttpMethod.GET,"/api/" 	+resourceId+ "/push/**")
    		.access("#oauth2.hasScope('trust')")
        .antMatchers(HttpMethod.POST,"/api/" 	+resourceId+ "/push/**")
    		.access("#oauth2.hasScope('trust')")
